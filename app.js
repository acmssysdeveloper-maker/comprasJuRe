...
*/
const APP_VERSION="2.8.6", DB_NAME="compras-jure-db", DB_VERSION=6;
...
async function clearStaleServiceWorkers(){
  ...
  try{
    ...
    if(!sessionStorage.getItem('jure-stale-cache-cleared-2.8.4')){
      sessionStorage.setItem('jure-stale-cache-cleared-2.8.4','1');
      const u=new URL(location.href); u.searchParams.set('jure','2.8.4');
