...
async function clearStaleServiceWorkers(){
  ...
  try{
    ...
    if(!sessionStorage.getItem('jure-stale-cache-cleared-2.8.6')){
      sessionStorage.setItem('jure-stale-cache-cleared-2.8.6','1');
      const u=new URL(location.href); u.searchParams.set('jure','2.8.6');
