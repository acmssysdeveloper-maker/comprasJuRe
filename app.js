...
*/
const APP_VERSION="2.8.13", DB_NAME="compras-jure-db", DB_VERSION=9;
...
async function clearStaleServiceWorkers(){
  ...
  try{
    ...
    if(!sessionStorage.getItem('jure-stale-cache-cleared-2.8.13')){
      sessionStorage.setItem('jure-stale-cache-cleared-2.8.13','1');
      const u=new URL(location.href); u.searchParams.set('jure','2.8.13');
...
const STORES=["meta","settings","markets","products","purchases","purchaseItems","lists","attachments","audit","sessions"];
const INITIAL_MARKETS=[
 {name:"Atakarejo",type:"Atacarejo",neighborhood:"Bacaxá",address:"Rod. Amaral Peixoto, km 70",city:"Saquarema",state:"RJ"},
 {name:"Supermarket",type:"Supermercado",neighborhood:"Bacaxá",address:"Rod. Amaral Peixoto, 263",city:"Saquarema",state:"RJ"},
 {name:"Supermarket",type:"Supermercado",neighborhood:"Bacaxá",address:"Av. Saquarema, 5236",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Esperança",type:"Supermercado",neighborhood:"Bacaxá",address:"Rua Pref. Francisco Fonseca, 171",city:"Saquarema",state:"RJ"},
 {name:"Juzan Supermercado",type:"Supermercado",neighborhood:"Bacaxá",address:"Rua José Souza, 46",city:"Saquarema",state:"RJ"},
 {name:"Mercado Saquadoce",type:"Mercado",neighborhood:"Bacaxá",address:"Rua Alfredo Menezes, 28",city:"Saquarema",state:"RJ"},
 {name:"Mercado Vila Pereira",type:"Mercado",neighborhood:"Bacaxá",address:"Rua Pereira, 365",city:"Saquarema",state:"RJ"},
 {name:"Mercado Frango Delícia",type:"Mercado",neighborhood:"Bacaxá",address:"Av. Saquarema, 5430",city:"Saquarema",state:"RJ"},
 {name:"Mercado e Panificadora Bela",type:"Mercado",neighborhood:"Bacaxá",address:"Trav. Noemia Costa, 04",city:"Saquarema",state:"RJ"},
 {name:"Mercado dos Suplementos",type:"Outros",neighborhood:"Centro",address:"Trav. Francisco Vignoli, 53",city:"Saquarema",state:"RJ"},
 {name:"Gomes Supermercados",type:"Supermercado",neighborhood:"Centro",address:"Av. Saquarema, 511",city:"Saquarema",state:"RJ"},
 {name:"Quali Preço",type:"Mercado",neighborhood:"Centro",address:"Avenida 8 de Maio, 469",city:"Saquarema",state:"RJ"},
 {name:"RC Cesta Básica",type:"Outros",neighborhood:"Centro",address:"Avenida 8 de Maio, 423",city:"Saquarema",state:"RJ"},
 {name:"Mercado e Bistrô Casa Divo",type:"Mercado",neighborhood:"Centro",address:"Rua Cel. Madureira, 40",city:"Saquarema",state:"RJ"},
 {name:"Padaria da Ponte",type:"Padaria",neighborhood:"Centro",address:"Avenida Saquarema, 350",city:"Saquarema",state:"RJ"},
 {name:"Gomes Supermercado",type:"Supermercado",neighborhood:"Porto da Roça",address:"Av. Saquarema, 4201",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Bassamar",type:"Supermercado",neighborhood:"Porto da Roça",address:"Av. Saquarema, 3674",city:"Saquarema",state:"RJ"},
 {name:"Juzan Supermercado",type:"Supermercado",neighborhood:"Porto da Roça",address:"Av. Saquarema, 4419",city:"Saquarema",state:"RJ"},
 {name:"Mercado Amigão do Bairro",type:"Mercado",neighborhood:"Porto da Roça",address:"Estr. Latino Melo Palmital, 113",city:"Saquarema",state:"RJ"},
 {name:"Supermercados JNH",type:"Supermercado",neighborhood:"Porto da Roça II",address:"Av. Saquarema, s/n",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Gomes Saquarema",type:"Supermercado",neighborhood:"Porto Novo",address:"Av. Saquarema, 637",city:"Saquarema",state:"RJ"},
 {name:"LEL Laticínios",type:"Mercado",neighborhood:"Porto Novo",address:"Av. Saquarema, 4600",city:"Saquarema",state:"RJ"},
 {name:"Mercadinho Pimenta Vermelha",type:"Mercado",neighborhood:"Porto Novo",address:"Av. Saquarema, 567",city:"Saquarema",state:"RJ"},
 {name:"Mercado ZapZap",type:"Mercado",neighborhood:"Porto Novo",address:"Av. Saquarema, 900",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Juzan",type:"Supermercado",neighborhood:"Rio da Areia",address:"Estr. Bacaxá Palmital, 13",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Juzan",type:"Supermercado",neighborhood:"Rio da Areia",address:"Estr. Latino Melo Palmital, 951",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Boa Sorte",type:"Supermercado",neighborhood:"Jaconé",address:"Rua 96, s/n",city:"Saquarema",state:"RJ"},
 {name:"Hortifruti Bem Viver",type:"Hortifruti",neighborhood:"Jaconé",address:"Rua 19",city:"Saquarema",state:"RJ"},
 {name:"Mercadinho Oceano",type:"Mercado",neighborhood:"Jaconé",address:"Rua Noventa e Seis, 1061",city:"Saquarema",state:"RJ"},
 {name:"Cantinho do Hortifruti",type:"Hortifruti",neighborhood:"Jaconé",address:"Rua 13, 1392",city:"Saquarema",state:"RJ"},
 {name:"Mercado Serena",type:"Mercado",neighborhood:"Sampaio Corrêa",address:"Estr. do Rio Mole, 05",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Almeida",type:"Supermercado",neighborhood:"Basileia",address:"Rua Vinte e Oito de Setembro",city:"Saquarema",state:"RJ"},
 {name:"Mini Mercado Felimar",type:"Mercado",neighborhood:"Barra Nova",address:"R. Simeão Dutra, 200",city:"Saquarema",state:"RJ"},
 {name:"Mercado Azeredo",type:"Mercado",neighborhood:"Barra Nova",address:"Av. Litorânea, 2071",city:"Saquarema",state:"RJ"},
 {name:"NCE Minimercado",type:"Mercado",neighborhood:"Barra Nova",address:"Rua João Alves Muniz, 50",city:"Saquarema",state:"RJ"},
 {name:"Horta Colha e Pague - Orgânica",type:"Hortifruti",neighborhood:"Barra Nova",address:"Rua B, Qd.03, Lt.13",city:"Saquarema",state:"RJ"},
 {name:"Supermercado Paraíso",type:"Supermercado",neighborhood:"Boqueirão",address:"Av. Nossa Senhora de Nazareth, 4014",city:"Saquarema",state:"RJ"},
 {name:"Mercado Boqueirão",type:"Mercado",neighborhood:"Boqueirão",address:"Av. Litorânea, 266",city:"Saquarema",state:"RJ"},
 {name:"L&M Citrus Lagos",type:"Hortifruti",neighborhood:"Boqueirão",address:"Rua José Maria Castanho, 620",city:"Saquarema",state:"RJ"},
 {name:"Mercado Magnú",type:"Mercado",neighborhood:"Vilatur",address:"Avenida Nova Saquarema, 423",city:"Saquarema",state:"RJ"},
 {name:"Mercado Santa Helena",type:"Mercado",neighborhood:"Vilatur",address:"Av. Praia de Itaúna, s/n",city:"Saquarema",state:"RJ"},
 {name:"Baratão de Vilatur",type:"Mercado",neighborhood:"Vilatur",address:"Av. Saquarema, 360",city:"Saquarema",state:"RJ"},
 {name:"Minimercado Douro",type:"Mercado",neighborhood:"Gravatá",address:"Rua João Vasconcelos, 001",city:"Saquarema",state:"RJ"},
 {name:"Mercado da Ana",type:"Mercado",neighborhood:"Itaúna",address:"Rua dos Robalos, 803",city:"Saquarema",state:"RJ"},
 {name:"Tchibum",type:"Outros",neighborhood:"Itaúna",address:"Rua dos Tatuís, esquina com Rua dos Robalos",city:"Saquarema",state:"RJ"},
 {name:"Mercado e Padaria Dois Irmãos",type:"Padaria",neighborhood:"Caixa d'Água",address:"Estr. da Caixa d'Água, 284",city:"Saquarema",state:"RJ"},
 {name:"Mercado e Mercearia Nova Itaúna",type:"Mercado",neighborhood:"Leigos",address:"Est. dos Leigos, s/n",city:"Saquarema",state:"RJ"},
 {name:"Mercado e Panificadora Pão de Ló",type:"Padaria",neighborhood:"Mombaça",address:"Estr. dos Bambus, 1209",city:"Saquarema",state:"RJ"},
 {name:"Gomes Supermercados",type:"Supermercado",neighborhood:"Mombaça",address:"Estr. dos Bambus, 2101",city:"Saquarema",state:"RJ"},
 {name:"Mercado 40 Graus",type:"Mercado",neighborhood:"Mombaça",address:"Rua Pref. Waldir Francisco Lima, 1305",city:"Saquarema",state:"RJ"},
 {name:"Mercado Gonçalense",type:"Mercado",neighborhood:"Bicuíba",address:"Rod. Amaral Peixoto, s/n",city:"Saquarema",state:"RJ"},
 {name:"Mercado Bicuíba",type:"Mercado",neighborhood:"Bicuíba",address:"Estr. dos Castros, 450",city:"Saquarema",state:"RJ"},
 {name:"Point dos Sonhos Mercado",type:"Mercado",neighborhood:"Coqueiral",address:"Rua Dolivaes Antunes Pinheiro, 342",city:"Saquarema",state:"RJ"},
 {name:"Mercado, Padaria e Hortifruti Amigão",type:"Padaria",neighborhood:"Coqueiral",address:"Rua Dolivaes Antunes Pinheiro, 550",city:"Saquarema",state:"RJ"},
 {name:"Mercado Tropical",type:"Mercado",neighborhood:"Rio Seco",address:"Av. Oliveira Viana, s/n",city:"Saquarema",state:"RJ"},
 {name:"Sacolão Saquarema Arca da Noa",type:"Hortifruti",neighborhood:"Rio Seco",address:"R. das Acácias, 237",city:"Saquarema",state:"RJ"},
 {name:"Mercado Barreto",type:"Mercado",neighborhood:"Barreira",address:"Rua Cap. Nunes, s/n",city:"Saquarema",state:"RJ"},
 {name:"Gabiangel Mercearia e Hortifruti",type:"Hortifruti",neighborhood:"Barreira",address:"R. Cap. Nunes, 1383",city:"Saquarema",state:"RJ"},
 {name:"Mini Mercado Arueira",type:"Mercado",neighborhood:"Bonsucesso",address:"Estr. da Água Branca, s/n",city:"Saquarema",state:"RJ"}
];
const SECTORS=["Laticínios","Padaria e Confeitaria","Carnes e Aves","Peixes e Frutos do Mar","Hortifruti","Mercearia","Bebidas","Biscoitos e Snacks","Chocolates e Doces","Congelados","Alimentos Naturais","Conservas e Molhos","Café, Chá e Achocolatados","Temperos, Condimentos e Ingredientes","Limpeza","Higiene Pessoal","Bebês e Crianças","Pet","Farmácia e Cuidados","Casa e Utilidades","Descartáveis","Papelaria e Papel","Lavanderia","Outros"];
const HEALTH_CLASSES=["Saudável","Não saudável","Não classificado"];
const LEGACY_SECTOR_MAP={"Biscoitos":"Biscoitos e Snacks","Higiene":"Higiene Pessoal","Padaria":"Padaria e Confeitaria","Carnes":"Carnes e Aves","Frios":"Carnes e Aves"};
const HEALTH_LEGACY_MAP={"Moderado":"Não saudável","Evitar":"Não saudável"};
...
const EMBEDDED_SEED={"schemaVersion":5,"appVersion":"2.8.13","settings":{"currency":"BRL","geminiModel":"gemini-3.7-flash","healthEnabled":true},"markets":[{"id":"mkt-alvorada-17833301002223","name":"Supermercados Alvorada","legalName":"SUPERMERCADOS ALVORADA EIRELI","cnpj":"17.833.301/0022-23","address":"Avenida Saquarema, 5236, Loja, Bacaxá (Bacaxá)","city":"Saquarema","state":"RJ","source":"receipt","createdAt":"2026-09-10T07:40:00-03:00","active":true}],"products":[{"id":"prod-085e56ca3888","barcode":"7891172523434","name":"Papel higiênico F.D. Neve 20m c/12","brand":"Neve","category":"Higiene Pessoal","pack":"12 rolos","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Higiene Pessoal"},{"id":"prod-113e2297a0b1","barcode":"2707","name":"Maçã Fuji","brand":"","category":"Hortifruti","pack":"kg","unit":"kg","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Hortifruti"},{"id":"prod-1864a771b772","barcode":"7894900701517","name":"Refrigerante Coca-Cola 2L Zero","brand":"Coca-Cola","category":"Bebidas","pack":"2 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Bebidas"},{"id":"prod-da21d9bbbfd2","barcode":"7891991001373","name":"Refrigerante Antarctica 2L Guaraná","brand":"Antarctica","category":"Bebidas","pack":"2 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Bebidas"},{"id":"prod-48750ed6282b","barcode":"609963576906","name":"Refrigerante Citrus Plus 2L","brand":"","category":"Bebidas","pack":"2 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Bebidas"},{"id":"prod-d65559f14fb6","barcode":"7898360430215","name":"Leite Integral Capel 1L","brand":"Capel","category":"Laticínios","pack":"1 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Laticínios"},{"id":"prod-de6febcb58b9","barcode":"7896005404195","name":"Refresco Maguary 1L Uva","brand":"Maguary","category":"Bebidas","pack":"1 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Bebidas"},{"id":"prod-a3717eb1fa5b","barcode":"7891150064935","name":"Lava-roupas Omo 900ml","brand":"Omo","category":"Limpeza","pack":"900 ml","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Limpeza"},{"id":"prod-66c1602a5482","barcode":"7896056406087","name":"Amaciante concentrado Urca 1L","brand":"Urca","category":"Limpeza","pack":"1 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Limpeza"},{"id":"prod-7045588e9429","barcode":"7897344201087","name":"Vinho Tinto Galo 1L Suave","brand":"Galo","category":"Bebidas","pack":"1 L","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Bebidas"},{"id":"prod-8460161b30cc","barcode":"7896016501739","name":"Milho para pipoca Granfino 500g","brand":"Granfino","category":"Mercearia","pack":"500 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Mercearia"},{"id":"prod-656ee86ca3a2","barcode":"7896005271612","name":"Mistura para bolo Boa S 400g","brand":"Boa S","category":"Mercearia","pack":"400 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Mercearia"},{"id":"prod-1ee17458fe09","barcode":"7896093300720","name":"Mistura para bolo Regina 400g","brand":"Regina","category":"Mercearia","pack":"400 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Mercearia"},{"id":"prod-d35bfa277cf0","barcode":"7891000099032","name":"Farinha láctea Nestlé 210g","brand":"Nestlé","category":"Mercearia","pack":"210 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Mercearia"},{"id":"prod-a66fed7de82d","barcode":"7896024761651","name":"Biscoito Maizena Piraquê 175g","brand":"Piraquê","category":"Biscoitos e Snacks","pack":"175 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Biscoitos e Snacks"},{"id":"prod-ecb1724c49cb","barcode":"7891910000197","name":"Açúcar refinado União 1kg","brand":"União","category":"Mercearia","pack":"1 kg","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Mercearia"},{"id":"prod-529635d729ed","barcode":"7898496681086","name":"Mistura para empanar Prático Supra","brand":"Prático","category":"Mercearia","pack":"","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Mercearia"},{"id":"prod-9ea34ca70361","barcode":"2516","name":"Presunto cozido Perdigão","brand":"Perdigão","category":"Carnes e Aves","pack":"kg","unit":"kg","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Carnes e Aves"},{"id":"prod-aa01fb8cebf5","barcode":"297","name":"Queijo prato fatiado","brand":"","category":"Carnes e Aves","pack":"kg","unit":"kg","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Carnes e Aves"},{"id":"prod-423b582d5e8c","barcode":"7894904271498","name":"Margarina Cremosa 500g","brand":"","category":"Laticínios","pack":"500 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Laticínios"},{"id":"prod-df8a46ad620c","barcode":"7891010518844","name":"Absorvente Sempre Livre LV32","brand":"Sempre Livre","category":"Higiene Pessoal","pack":"32 un","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Higiene Pessoal"},{"id":"prod-64e18dead830","barcode":"7896982103388","name":"Ovos brancos Mantiqueira c/20","brand":"Mantiqueira","category":"Laticínios","pack":"20 un","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Laticínios"},{"id":"prod-bd7f666d4293","barcode":"7891193010074","name":"Pão For S Boys 450g Trad","brand":"For S Boys","category":"Padaria e Confeitaria","pack":"450 g","unit":"un","health":"Não classificado","active":true,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","sector":"Padaria e Confeitaria"}],"purchases":[{"id":"purchase-20260910-alvorada","date":"2026-09-10","time":"07:37:19","marketId":"mkt-alvorada-17833301002223","marketName":"Supermercados Alvorada","cnpj":"17.833.301/0022-23","legalName":"SUPERMERCADOS ALVORADA EIRELI","address":"Avenida Saquarema, 5236, Loja, Bacaxá (Bacaxá)","city":"Saquarema","state":"RJ","total":350.01,"itemCount":23,"discountTotal":2.0,"paymentMethod":"Cartão de débito","receiptReference":"test-fixtures/comprovante-alvorada-2026-09-10.jpg","receiptName":"comprovante-alvorada-2026-09-10.jpg","source":"seed-receipt","status":"confirmed-with-review","createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","documentNumber":"383983","active":true}],"purchaseItems":[{"id":"item-20260910-01","purchaseId":"purchase-20260910-alvorada","productId":"prod-085e56ca3888","barcode":"7891172523434","descriptionRaw":"Papel higiênico F.D. Neve 20m c/12","quantity":2,"unit":"un","pack":"12 rolos","unitPrice":14.9,"lineTotal":29.8,"discount":2.0,"totalAfterDiscount":27.8,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Higiene Pessoal","healthSnapshot":"Não classificado"},{"id":"item-20260910-02","purchaseId":"purchase-20260910-alvorada","productId":"prod-113e2297a0b1","barcode":"2707","descriptionRaw":"Maçã Fuji","quantity":1.6,"unit":"kg","pack":"kg","unitPrice":11.98,"lineTotal":19.17,"discount":0,"totalAfterDiscount":19.17,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Hortifruti","healthSnapshot":"Não classificado"},{"id":"item-20260910-03","purchaseId":"purchase-20260910-alvorada","productId":"prod-1864a771b772","barcode":"7894900701517","descriptionRaw":"Refrigerante Coca-Cola 2L Zero","quantity":1,"unit":"un","pack":"2 L","unitPrice":10.49,"lineTotal":10.49,"discount":0,"totalAfterDiscount":10.49,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Bebidas","healthSnapshot":"Não classificado"},{"id":"item-20260910-04","purchaseId":"purchase-20260910-alvorada","productId":"prod-da21d9bbbfd2","barcode":"7891991001373","descriptionRaw":"Refrigerante Antarctica 2L Guaraná","quantity":1,"unit":"un","pack":"2 L","unitPrice":6.59,"lineTotal":6.59,"discount":0,"totalAfterDiscount":6.59,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Bebidas","healthSnapshot":"Não classificado"},{"id":"item-20260910-05","purchaseId":"purchase-20260910-alvorada","productId":"prod-48750ed6282b","barcode":"609963576906","descriptionRaw":"Refrigerante Citrus Plus 2L","quantity":1,"unit":"un","pack":"2 L","unitPrice":5.99,"lineTotal":5.99,"discount":0,"totalAfterDiscount":5.99,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Bebidas","healthSnapshot":"Não classificado"},{"id":"item-20260910-06","purchaseId":"purchase-20260910-alvorada","productId":"prod-d65559f14fb6","barcode":"7898360430215","descriptionRaw":"Leite Integral Capel 1L","quantity":6,"unit":"un","pack":"1 L","unitPrice":4.79,"lineTotal":28.74,"discount":0,"totalAfterDiscount":28.74,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Laticínios","healthSnapshot":"Não classificado"},{"id":"item-20260910-07","purchaseId":"purchase-20260910-alvorada","productId":"prod-de6febcb58b9","barcode":"7896005404195","descriptionRaw":"Refresco Maguary 1L Uva","quantity":2,"unit":"un","pack":"1 L","unitPrice":4.99,"lineTotal":9.98,"discount":0,"totalAfterDiscount":9.98,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Bebidas","healthSnapshot":"Não classificado"},{"id":"item-20260910-08","purchaseId":"purchase-20260910-alvorada","productId":"prod-a3717eb1fa5b","barcode":"7891150064935","descriptionRaw":"Lava-roupas Omo 900ml","quantity":1,"unit":"un","pack":"900 ml","unitPrice":17.89,"lineTotal":17.89,"discount":0,"totalAfterDiscount":17.89,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Limpeza","healthSnapshot":"Não classificado"},{"id":"item-20260910-09","purchaseId":"purchase-20260910-alvorada","productId":"prod-66c1602a5482","barcode":"7896056406087","descriptionRaw":"Amaciante concentrado Urca 1L","quantity":1,"unit":"un","pack":"1 L","unitPrice":10.89,"lineTotal":10.89,"discount":0,"totalAfterDiscount":10.89,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Limpeza","healthSnapshot":"Não classificado"},{"id":"item-20260910-10","purchaseId":"purchase-20260910-alvorada","productId":"prod-7045588e9429","barcode":"7897344201087","descriptionRaw":"Vinho Tinto Galo 1L Suave","quantity":1,"unit":"un","pack":"1 L","unitPrice":29.98,"lineTotal":29.98,"discount":0,"totalAfterDiscount":29.98,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Bebidas","healthSnapshot":"Não classificado"},{"id":"item-20260910-11","purchaseId":"purchase-20260910-alvorada","productId":"prod-8460161b30cc","barcode":"7896016501739","descriptionRaw":"Milho para pipoca Granfino 500g","quantity":5,"unit":"un","pack":"500 g","unitPrice":5.49,"lineTotal":27.45,"discount":0,"totalAfterDiscount":27.45,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Mercearia","healthSnapshot":"Não classificado"},{"id":"item-20260910-12","purchaseId":"purchase-20260910-alvorada","productId":"prod-656ee86ca3a2","barcode":"7896005271612","descriptionRaw":"Mistura para bolo Boa S 400g","quantity":1,"unit":"un","pack":"400 g","unitPrice":6.99,"lineTotal":6.99,"discount":0,"totalAfterDiscount":6.99,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Mercearia","healthSnapshot":"Não classificado"},{"id":"item-20260910-13","purchaseId":"purchase-20260910-alvorada","productId":"prod-1ee17458fe09","barcode":"7896093300720","descriptionRaw":"Mistura para bolo Regina 400g","quantity":2,"unit":"un","pack":"400 g","unitPrice":5.49,"lineTotal":10.98,"discount":0,"totalAfterDiscount":10.98,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Mercearia","healthSnapshot":"Não classificado"},{"id":"item-20260910-14","purchaseId":"purchase-20260910-alvorada","productId":"prod-d35bfa277cf0","barcode":"7891000099032","descriptionRaw":"Farinha láctea Nestlé 210g","quantity":1,"unit":"un","pack":"210 g","unitPrice":6.99,"lineTotal":6.99,"discount":0,"totalAfterDiscount":6.99,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Mercearia","healthSnapshot":"Não classificado"},{"id":"item-20260910-15","purchaseId":"purchase-20260910-alvorada","productId":"prod-a66fed7de82d","barcode":"7896024761651","descriptionRaw":"Biscoito Maizena Piraquê 175g","quantity":3,"unit":"un","pack":"175 g","unitPrice":2.99,"lineTotal":8.97,"discount":0,"totalAfterDiscount":8.97,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Biscoitos e Snacks","healthSnapshot":"Não classificado"},{"id":"item-20260910-16","purchaseId":"purchase-20260910-alvorada","productId":"prod-ecb1724c49cb","barcode":"7891910000197","descriptionRaw":"Açúcar refinado União 1kg","quantity":1,"unit":"un","pack":"1 kg","unitPrice":3.19,"lineTotal":3.19,"discount":0,"totalAfterDiscount":3.19,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Mercearia","healthSnapshot":"Não classificado"},{"id":"item-20260910-17","purchaseId":"purchase-20260910-alvorada","productId":"prod-529635d729ed","barcode":"7898496681086","descriptionRaw":"Mistura para empanar Prático Supra","quantity":1,"unit":"un","pack":"","unitPrice":11.79,"lineTotal":11.79,"discount":0,"totalAfterDiscount":11.79,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Mercearia","healthSnapshot":"Não classificado"},{"id":"item-20260910-18","purchaseId":"purchase-20260910-alvorada","productId":"prod-9ea34ca70361","barcode":"2516","descriptionRaw":"Presunto cozido Perdigão","quantity":0.236,"unit":"kg","pack":"kg","unitPrice":26.98,"lineTotal":6.37,"discount":0,"totalAfterDiscount":6.37,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Carnes e Aves","healthSnapshot":"Não classificado"},{"id":"item-20260910-19","purchaseId":"purchase-20260910-alvorada","productId":"prod-aa01fb8cebf5","barcode":"297","descriptionRaw":"Queijo prato fatiado","quantity":0.308,"unit":"kg","pack":"kg","unitPrice":57.99,"lineTotal":17.86,"discount":0,"totalAfterDiscount":17.86,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Carnes e Aves","healthSnapshot":"Não classificado"},{"id":"item-20260910-20","purchaseId":"purchase-20260910-alvorada","productId":"prod-423b582d5e8c","barcode":"7894904271498","descriptionRaw":"Margarina Cremosa 500g","quantity":2,"unit":"un","pack":"500 g","unitPrice":4.99,"lineTotal":9.98,"discount":0,"totalAfterDiscount":9.98,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Laticínios","healthSnapshot":"Não classificado"},{"id":"item-20260910-21","purchaseId":"purchase-20260910-alvorada","productId":"prod-df8a46ad620c","barcode":"7891010518844","descriptionRaw":"Absorvente Sempre Livre LV32","quantity":1,"unit":"un","pack":"32 un","unitPrice":39.98,"lineTotal":39.98,"discount":0,"totalAfterDiscount":39.98,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Higiene Pessoal","healthSnapshot":"Não classificado"},{"id":"item-20260910-22","purchaseId":"purchase-20260910-alvorada","productId":"prod-64e18dead830","barcode":"7896982103388","descriptionRaw":"Ovos brancos Mantiqueira c/20","quantity":2,"unit":"un","pack":"20 un","unitPrice":12.98,"lineTotal":25.96,"discount":0,"totalAfterDiscount":25.96,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Laticínios","healthSnapshot":"Não classificado"},{"id":"item-20260910-23","purchaseId":"purchase-20260910-alvorada","productId":"prod-bd7f666d4293","barcode":"7891193010074","descriptionRaw":"Pão For S Boys 450g Trad","quantity":1,"unit":"un","pack":"450 g","unitPrice":5.98,"lineTotal":5.98,"discount":0,"totalAfterDiscount":5.98,"confidence":0.99,"needsReview":false,"createdAt":"2026-09-10T21:00:00-03:00","updatedAt":"2026-09-10T21:00:00-03:00","purchaseDate":"2026-09-10","active":true,"sectorSnapshot":"Padaria e Confeitaria","healthSnapshot":"Não classificado"}],"lists":[],"audit":[{"id":"audit-seed-001","type":"seed","entity":"purchase","entityId":"purchase-20260910-alvorada","at":"2026-09-10T21:00:00-03:00","message":"Compra inicial cadastrada a partir do comprovante real enviado. Soma dos itens líquidos = R$ 350,01; total fiscal = R$ 350,01."}],"appMeta":{"lastBackupAt":null,"source":"seed","auditEnabled":true}}
function openDB(){
  return new Promise((resolve,reject)=>{
    const req=indexedDB.open(DB_NAME,DB_VERSION);
    req.onupgradeneeded=()=>{const d=req.result; for(const s of STORES){if(!d.objectStoreNames.contains(s)){const st=d.createObjectStore(s,{keyPath:"id"}); if(["products","markets","purchases","sessions"].includes(s)){st.createIndex("active","active");if(s==="markets")st.createIndex("neighborhood","neighborhood");} if(s==="purchaseItems"){st.createIndex("purchaseId","purchaseId");st.createIndex("productId","productId")}}}};
...
async function seedIfEmpty(){
  ...
  await put("meta",{id:"meta",schemaVersion:5,appVersion:APP_VERSION,seededAt:todayISO()});
}
async function seedInitialMarkets(){
 const existing=await getAll("markets");
 for(const x of INITIAL_MARKETS){
  const same=existing.find(m=>normalize(m.name)===normalize(x.name)&&normalize(m.neighborhood||"")===normalize(x.neighborhood||"")&&normalize(m.address||"")===normalize(x.address||""));
  if(same)continue;
  const dupName=existing.find(m=>normalize(m.name)===normalize(x.name)&&normalize(m.neighborhood||"")===normalize(x.neighborhood||"")&&(!x.address||normalize(m.address||"")===normalize(x.address||"")));
  if(dupName)continue;
  const m={id:uid("market"),...x,legalName:x.name,cnpj:"",createdAt:todayISO(),updatedAt:todayISO(),active:true,source:"seed-saquarema"};
  await put("markets",m); existing.push(m);
 }
}
async function migrate(){
  ...
  if(from<5){
    ...
    for(const p of products){const sector=SECTORS.includes(p.sector)?p.sector:(LEGACY_SECTOR_MAP[p.category]||(SECTORS.includes(p.category)?p.category:"Outros"));const health=HEALTH_CLASSES.includes(p.health)?p.health:(HEALTH_LEGACY_MAP[p.health]||"Não classificado");await put("products",{...p,sector,category:sector,health,updatedAt:p.updatedAt||todayISO()});}
    const products2=await getAll("products"),byProduct=new Map(products2.map(x=>[x.id,x]));
    for(const i of await getAll("purchaseItems")){const p=byProduct.get(i.productId);if(p)await put("purchaseItems",{...i,sectorSnapshot:i.sectorSnapshot||p.sector||p.category||"Outros",healthSnapshot:i.healthSnapshot||p.health||"Não classificado"});}
    await put("meta",{id:"meta",schemaVersion:5,appVersion:APP_VERSION,migratedAt:todayISO()});
  } else await put("meta",{...m,schemaVersion:Math.max(5,Number(m.schemaVersion||5)),appVersion:APP_VERSION});
  if(from<6){ await seedInitialMarkets(); const markets=await getAll("markets"); for(const market of markets){ if(market.city==="Saquarema"&&!market.neighborhood&&/Bacaxá|Saquarema|Amaral Peixoto|Av\. Saquarema/i.test(String(market.address||""))){ await put("markets",{...market,neighborhood:market.neighborhood||"Bacaxá",updatedAt:todayISO()}); } } await put("meta",{id:"meta",schemaVersion:6,appVersion:APP_VERSION,migratedAt:todayISO()}); } else await put("meta",{...m,schemaVersion:Math.max(6,Number(m.schemaVersion||6)),appVersion:APP_VERSION});
  if(from<7){ await seedInitialMarkets(); await put("meta",{id:"meta",schemaVersion:7,appVersion:APP_VERSION,migratedAt:todayISO()}); } else await put("meta",{...m,schemaVersion:Math.max(7,Number(m.schemaVersion||7)),appVersion:APP_VERSION});
}
async function ensureDB(){await openDB();await seedIfEmpty();await migrate();if(!(await getOne("meta","meta"))?.schemaVersion||Number((await getOne("meta","meta"))?.schemaVersion)<6)await seedInitialMarkets()}
...
async function renderDashboard(){
  ...
  const max=Math.max(...Object.values(map),1);$("#categoryChart").innerHTML=Object.entries(map).sort((a,b)=>b[1]-a[1]).map(([k,v])=>`<div class="metric-bar"><div><span>${esc(k)}</span><b>${money(v)}</b></div><i style="width:${v/max*100}%"></i></div>`).join("")||"<div class='muted'>Sem dados.</div>";const healthMap={"Saudável":0,"Não saudável":0,"Não classificado":0},sectorMap={};for(const i of its){const p=d.products.find(x=>x.id===i.productId),h=i.healthSnapshot||p?.health||"Não classificado",sec=i.sectorSnapshot||p?.sector||p?.category||"Outros";healthMap[HEALTH_CLASSES.includes(h)?h:"Não classificado"]+=num(i.totalAfterDiscount??i.lineTotal);sectorMap[sec]=(sectorMap[sec]||0)+num(i.totalAfterDiscount??i.lineTotal)}const hm=Math.max(...Object.values(healthMap),1),sm=Math.max(...Object.values(sectorMap),1);if($("#healthChart"))$("#healthChart").innerHTML=Object.entries(healthMap).map(([k,v])=>`<div class="metric-bar"><div><span>${esc(k)}</span><b>${money(v)}</b></div><i style="width:${v/hm*100}%"></i></div>`).join("");if($("#sectorChart"))$("#sectorChart").innerHTML=Object.entries(sectorMap).sort((a,b)=>b[1]-a[1]).slice(0,8).map(([k,v])=>`<div class="metric-bar"><div><span>${esc(k)}</span><b>${money(v)}</b></div><i style="width:${v/sm*100}%"></i></div>`).join("")||"<div class='muted'>Sem dados.</div>";
...
async function renderLists(){
  ...
  $("#listsArea").innerHTML=lists.map(l=>{
    ...
    return `<div class="stack-card list-card">
      ...
      <div class="purchase-actions"><button class="primary" onclick="openActiveList('${l.id}')">Abrir lista</button><button class="ghost" onclick="archiveList('${l.id}')">Arquivar</button></div></div>
...
$("#newListBtn").onclick=()=>newListModal();$("#backToListsBtn").onclick=()=>go("listas");

let activeListId=null;
async function ensureListSession(l,marketId){
 const d=await data();const market=d.markets.find(m=>m.id===marketId&&m.active!==false);if(!market)return l;
 let sessions=Array.isArray(l.sessions)?[...l.sessions]:[];let current=sessions.find(x=>x.marketId===market.id&&x.active!==false);
 if(!current){current={id:uid("session"),marketId:market.id,marketName:market.name,startedAt:todayISO(),active:true};sessions.push(current);await audit(`Nova sessão de compras iniciada em ${market.name}.`,`list`,l.id,"session-start")}
 return {...l,activeMarketId:market.id,activeSessionId:current.id,sessions,updatedAt:todayISO()};
}
async function renderActiveList(id=activeListId){
 if(!id){go("listas");return} activeListId=id;const d=await data(),l=d.lists.find(x=>x.id===id&&x.active!==false);if(!l){toast("Lista não encontrada.");go("listas");return}
 const area=$("#activeListArea");if(!area)return;$("#activeListTitle").textContent=l.name;const items=l.items||[];const activeMarketId=l.activeMarketId||l.lastMarketId||d.markets.find(m=>m.active!==false)?.id||"";const activeMarket=d.markets.find(m=>m.id===activeMarketId);
 const remaining=items.filter(x=>x.included!==false&&!x.checked),bought=items.filter(x=>x.included!==false&&x.checked),included=items.filter(x=>x.included!==false).length,total=items.reduce((sum,x)=>sum+num(x.price)*(num(x.qty)||1),0);
 const marketOptionsHtml=d.markets.filter(m=>m.active!==false).sort((a,b)=>String(a.name).localeCompare(String(b.name))).map(m=>`<option value="${esc(m.id)}" ${m.id===activeMarketId?'selected':''}>${esc(m.name)}</option>`).join("");
 const itemCard=(it,idx)=>{const p=d.products.find(x=>x.id===it.productId),unit=p?.unit||"un",health=p?.health||"Não classificado";return `<article class="market-item-card ${it.checked?'is-checked':''}"><label class="market-check"><input type="checkbox" data-market-check="${idx}" ${it.checked?'checked':''}><span class="check-box" aria-hidden="true">✓</span></label><div class="market-item-main"><strong>${esc(it.name)}</strong><small>${esc([p?.brand,p?.pack].filter(Boolean).join(' · '))||'Item de compra'} · ${fmtQty(it.qty||1)} ${esc(unit)}</small><span class="health-mini ${health==='Saudável'?'health-good':health==='Não saudável'?'health-bad':'health-pending'}">${esc(health)}</span></div><label class="market-price"><span>Preço unit.</span><input data-market-price="${idx}" inputmode="decimal" value="${it.price!=null&&it.price!==''?String(it.price).replace('.',','):''}" placeholder="0,00"></label><button class="market-include ${it.included===false?'include-off':''}" data-market-include="${idx}" type="button">${it.included===false?'Incluir':'Incluído'}</button></article>`};
 area.innerHTML=`<div class="market-session"><div><span class="eyebrow">SESSÃO ATUAL</span><strong>🏪 ${esc(activeMarket?.name||'Selecione o estabelecimento')}</strong><small>Os itens marcados nesta sessão ficam vinculados automaticamente a este estabelecimento.</small></div><div class="market-session-actions"><select id="activeMarketSelect" aria-label="Estabelecimento da sessão"><option value="">Selecionar estabelecimento</option>${marketOptionsHtml}</select><button class="ghost" id="changeMarketSession">Trocar estabelecimento</button></div></div>
 <div class="market-list-toolbar"><div><strong>${remaining.length}</strong><span>faltam</span></div><div><strong>${bought.length}</strong><span>no carrinho</span></div><div><strong>${money(total)}</strong><span>valor informado</span></div><button class="primary" id="saveActiveListTop">Salvar</button></div>
 <div class="market-list-add panel"><div class="panel-head"><div><h3>Incluir item</h3><small>Adicione um produto do catálogo durante a compra.</small></div></div><div class="market-add-row"><input id="marketItemSearch" placeholder="Buscar produto pelo nome" autocomplete="off"><button class="primary" id="marketAddBtn">Incluir</button></div><div id="marketSearchResults" class="market-search-results"></div></div>
 <section class="market-section"><div class="market-section-head"><h3>FALTAM <span>${remaining.length}</span></h3><small>Marque assim que colocar no carrinho.</small></div><div class="market-list-grid">${remaining.map((it)=>itemCard(it,items.indexOf(it))).join('')||`<div class="panel empty-list"><b>Você já marcou todos os itens desta sessão.</b><p>Se precisar, inclua um novo produto acima.</p></div>`}</div></section>
 <details class="market-bought"><summary>COMPRADOS / NO CARRINHO · ${bought.length}</summary><div class="market-list-grid">${bought.map(it=>itemCard(it,items.indexOf(it))).join('')||`<p class="muted">Nenhum item marcado ainda.</p>`}</div></details>
 <div class="market-list-footer"><button class="primary" id="saveActiveList">Salvar lista</button><button class="ghost" id="finishMarketBtn">Finalizar ida ao mercado</button></div>`;
 const save=async()=>{const current=items.map((it,i)=>{const c=$(`[data-market-check="${i}"]`),pr=$(`[data-market-price="${i}"]`);const checked=!!c?.checked;return {...it,checked,price:pr?.value?num(pr.value):it.price??null,included:it.included!==false,sessionId:checked?(l.activeSessionId||null):it.sessionId||null,marketId:checked?(l.activeMarketId||null):it.marketId||null,checkedAt:checked?(it.checkedAt||todayISO()):it.checkedAt||null}});await put("lists",{...l,items:current,lastUsedAt:todayISO(),updatedAt:todayISO()});await audit("Lista atualizada no modo mercado; estabelecimento definido pela sessão.","list",l.id,"change");toast("Lista salva.");await renderActiveList(l.id)};
 $("#saveActiveList")?.addEventListener('click',save);$("#saveActiveListTop")?.addEventListener('click',save);
 $("#changeMarketSession")?.addEventListener('click',async()=>{const marketId=$("#activeMarketSelect").value;if(!marketId)return toast("Selecione o estabelecimento.");const next=await ensureListSession(l,marketId);await put("lists",next);await renderActiveList(l.id);toast(`Sessão ativa: ${d.markets.find(m=>m.id===marketId)?.name||'estabelecimento'}.`)});
 $$('[data-market-include]').forEach(btn=>btn.onclick=async()=>{const i=Number(btn.dataset.marketInclude),cur=await getOne('lists',l.id);if(!cur)return;const next=[...(cur.items||[])];next[i]={...next[i],included:next[i].included===false};if(next[i].included===false)next[i].checked=false;await put('lists',{...cur,items:next,updatedAt:todayISO()});await renderActiveList(l.id)});
 $$('[data-market-check]').forEach(x=>x.addEventListener('change',async()=>{const i=Number(x.dataset.marketCheck),cur=await getOne('lists',l.id);if(!cur)return;const next=[...(cur.items||[])];next[i]={...next[i],checked:x.checked,sessionId:x.checked?(cur.activeSessionId||null):next[i].sessionId||null,marketId:x.checked?(cur.activeMarketId||null):next[i].marketId||null,checkedAt:x.checked?todayISO():next[i].checkedAt||null};await put('lists',{...cur,items:next,updatedAt:todayISO()});await renderActiveList(l.id)}));
 const search=()=>{const q=normalize($("#marketItemSearch")?.value||'');const results=(d.products||[]).filter(p=>p.active!==false&&(!q||normalize(p.name).includes(q)||normalize(p.brand||'').includes(q))).slice(0,8);$("#marketSearchResults").innerHTML=results.map(p=>`<button class="market-search-result" data-add-product="${esc(p.id)}"><span><b>${esc(p.name)}</b><small>${esc([p.brand,p.pack].filter(Boolean).join(' · '))}</small></span><strong>Incluir</strong></button>`).join('')||`<span class="muted">Nenhum produto encontrado.</span>`;$$('[data-add-product]').forEach(b=>b.onclick=async()=>{const prod=d.products.find(x=>x.id===b.dataset.addProduct),cur=await getOne('lists',l.id);if(!prod||!cur)return;const next=[...(cur.items||[])],existing=next.find(x=>x.productId===prod.id&&x.included!==false&&!x.checked);if(existing)existing.qty=Math.max(.001,num(existing.qty)||1)+1;else next.push({productId:prod.id,name:prod.name,qty:1,checked:false,price:null,included:true});await put('lists',{...cur,items:next,updatedAt:todayISO()});await audit(`Item incluído na lista durante a compra: ${prod.name}.`,'list',l.id,'change');await renderActiveList(l.id)});};$("#marketItemSearch")?.addEventListener('input',search);search();$("#finishMarketBtn")?.addEventListener('click',()=>openList(l.id));
}
...
window.openActiveList=async id=>{activeListId=id;go("lista-ativa");await renderActiveList(id)};
window.openList=async id=>{
 ...
 $("#registerListPurchase").onclick=async()=>{
   ...
   const checkedItems=items.filter(x=>x.checked&&x.included!==false);const productsById=new Map(d.products.map(x=>[x.id,x]));
   for(const it of checkedItems){const prod=productsById.get(it.productId),price=it.price!=null?num(it.price):0;if(price>0){await put("purchaseItems",{id:uid("item"),purchaseId:p.id,productId:it.productId,barcode:prod?.barcode||"",descriptionRaw:it.name,quantity:num(it.qty)||1,unit:prod?.unit||"un",pack:prod?.pack||"",unitPrice:price,lineTotal:round2((num(it.qty)||1)*price),discount:0,totalAfterDiscount:round2((num(it.qty)||1)*price),confidence:1,needsReview:false,source:"manual-list",sessionId:it.sessionId||l.activeSessionId||null,marketId:it.marketId||l.activeMarketId||market.id,sectorSnapshot:prod?.sector||prod?.category||"Outros",healthSnapshot:prod?.health||"Não classificado",purchaseDate:date,createdAt:todayISO(),updatedAt:todayISO(),active:true});}}
   const sessionItems=items.map(x=>x.checked?{productId:x.productId,name:x.name,qty:x.qty,price:x.price||null,marketId:x.marketId||market.id,sessionId:x.sessionId||l.activeSessionId||null,purchasedAt:date}:x);
   const nextSession={id:uid("session"),marketId:market.id,marketName:market.name,startedAt:todayISO(),active:true};const nextList={...l,items:sessionItems,sessions:[...(l.sessions||[]),nextSession],activeSessionId:nextSession.id,activeMarketId:market.id,lastMarketId:market.id,lastUsedAt:date,updatedAt:todayISO()};await put("lists",nextList);await audit(`Ida ao mercado registrada pela lista "${l.name}"; itens marcados vinculados à sessão e ao estabelecimento.` ,"purchase",p.id,"create");
...
function registerProductModal(onSaved){
 const body=`<div class="form-grid"><label>Nome do produto *<input id="npName" placeholder="Ex.: Arroz 5 kg"></label><label>Marca<input id="npBrand" placeholder="Opcional"></label><label>Setor *<select id="npCat">${SECTORS.map(x=>`<option>${x}</option>`).join("")}</select></label><label>Classificação *<select id="npHealth"><option value="">Selecione</option><option>Saudável</option><option>Não saudável</option></select></label><label>Embalagem<input id="npPack" placeholder="Ex.: 5 kg"></label><label>Unidade<select id="npUnit"><option>un</option><option>kg</option><option>g</option><option>L</option><option>mL</option><option>caixa</option><option>pacote</option></select></label><label>Código/EAN<input id="npBarcode" inputmode="numeric"></label></div><div class="classification-note"><b>Classificação do produto</b><span>O setor e o perfil alimentar alimentam filtros, histórico, gráficos e Insights. O app não decide essa classificação por você.</span></div><div class="button-row" style="margin-top:13px"><button class="primary" id="saveNewProduct">Cadastrar produto</button><button class="ghost" onclick="closeModal()">Cancelar</button></div>`;
 openModal("Cadastrar produto",body);
 $("#saveNewProduct").onclick=async()=>{const name=$("#npName").value.trim(),health=$("#npHealth").value,sector=$("#npCat").value;if(!name)return toast("Informe o nome do produto.");if(!health)return toast("Selecione Saudável ou Não saudável.");const d=await data(),barcode=String($("#npBarcode").value||"").replace(/\D/g,"");const duplicate=d.products.find(p=>p.active!==false&&(normalize(p.name)===normalize(name)||(barcode&&String(p.barcode||"")===barcode)));if(duplicate)return toast(`Este produto já está cadastrado: ${duplicate.name}.`);const prod={id:uid("prod"),barcode,name,brand:$("#npBrand").value.trim(),sector,category:sector,pack:$("#npPack").value.trim(),unit:$("#npUnit").value.trim()||"un",health,active:true,createdAt:todayISO(),updatedAt:todayISO()};await put("products",prod);await audit("Produto cadastrado com setor e classificação obrigatórios.","product",prod.id,"create");if(typeof onSaved==="function")await onSaved();closeModal();toast("Produto cadastrado.")};
}
async function renderProducts(){const d=await data(),q=normalize($("#productSearch")?.value||""),sector=$("#productSectorFilter")?.value||"",health=$("#healthFilter")?.value||"";const sectors=[...new Set(d.products.map(p=>p.sector||p.category).filter(Boolean))].sort();$("#productSectorFilter").innerHTML=`<option value="">Todos os setores</option>${sectors.map(c=>`<option ${c===sector?"selected":""}>${esc(c)}</option>`).join("")}`;const rows=d.products.filter(p=>p.active!==false&&(!q||normalize(p.name+" "+p.brand+" "+p.pack).includes(q))&&(!sector||(p.sector||p.category)===sector)&&(!health||p.health===health)).map(p=>{const its=d.purchaseItems.filter(i=>i.productId===p.id),last=its.slice().sort((a,b)=>(b.purchaseDate||"").localeCompare(a.purchaseDate||"")).at(0),h=p.health||"Não classificado";return `<tr><td><b>${esc(p.name)}</b><br><small>${esc(p.brand||"marca não informada")}</small></td><td>${esc(p.sector||p.category||"—")}</td><td><span class="health-pill ${h==='Saudável'?'health-good':h==='Não saudável'?'health-bad':'health-pending'}">${esc(h)}</span></td><td>${esc(p.pack||"—")} · ${esc(p.unit||"")}</td><td>${last?money(last.unitPrice):"—"}</td><td>${its.length}</td><td><div class="button-row compact"><button class="link" onclick="editProduct('${p.id}')">Editar</button><button class="link danger-link" onclick="deleteProduct('${p.id}')">Excluir</button></div></td></tr>`}).join("");$("#productsTable").innerHTML=rows||"<tr><td colspan='7'>Nenhum produto encontrado.</td></tr>"}
$("#productSearch").oninput=()=>renderProducts();$("#productSectorFilter").onchange=()=>renderProducts();$("#healthFilter").onchange=()=>renderProducts();if($("#newProductBtn"))$("#newProductBtn").onclick=()=>registerProductModal(renderProducts);
if($("#listTemplateBtn"))$("#listTemplateBtn").onclick=()=>window.downloadListTemplateXlsx();if($("#listXlsxBtn")){$("#listXlsxBtn").onclick=()=>$("#listXlsxFile").click();$("#listXlsxFile").onchange=async e=>{const f=e.target.files?.[0];if(f)await window.importListXlsx(f);e.target.value=""}};if($("#importListXlsxFromImportBtn"))$("#importListXlsxFromImportBtn").onclick=()=>$("#listXlsxFile")?.click();if($("#goListsFromImportBtn"))$("#goListsFromImportBtn").onclick=()=>go("listas");
window.editProduct=async id=>{const p=await getOne("products",id);if(!p)return;const currentSector=p.sector||p.category||"Outros",currentHealth=HEALTH_CLASSES.includes(p.health)?p.health:"Não classificado";openModal("Editar produto",`<div class="form-grid"><label>Nome *<input id="epName" value="${esc(p.name)}"></label><label>Marca<input id="epBrand" value="${esc(p.brand||"")}"></label><label>Setor *<select id="epCat">${SECTORS.map(c=>`<option ${c===currentSector?"selected":""}>${c}</option>`).join("")}</select></label><label>Classificação *<select id="epHealth"><option value="">Selecione</option><option ${currentHealth==='Saudável'?"selected":""}>Saudável</option><option ${currentHealth==='Não saudável'?"selected":""}>Não saudável</option><option ${currentHealth==='Não classificado'?"selected":""}>Não classificado</option></select></label><label>Embalagem<input id="epPack" value="${esc(p.pack||"")}"></label><label>Unidade<input id="epUnit" value="${esc(p.unit||"un")}"></label></div><div class="classification-note"><b>Histórico protegido</b><span>Compras antigas mantêm seu setor e classificação registrados no momento da compra.</span></div><div class="button-row" style="margin-top:13px"><button class="primary" id="saveEp">Salvar</button><button class="ghost" onclick="closeModal()">Cancelar</button></div>`);$("#saveEp").onclick=async()=>{const h=$("#epHealth").value;if(!h)return toast("Selecione a classificação.");const sector=$("#epCat").value;await put("products",{...p,name:$("#epName").value.trim()||p.name,brand:$("#epBrand").value.trim(),sector,category:sector,pack:$("#epPack").value.trim(),unit:$("#epUnit").value.trim()||"un",health:h,updatedAt:todayISO()});await audit("Produto corrigido; histórico de compras preservado.","product",id);closeModal();await renderProducts();toast("Produto atualizado.")}};
...
async function renderMarkets(){
 ...
 for(const p of active){const row=stats.get(p.marketId)||{market:{id:p.marketId,name:p.marketName,cnpj:p.cnpj,city:p.city,state:p.state,neighborhood:""},total:0,count:0,manual:0,receipt:0};row.total+=num(p.total);row.count++;if(p.source==="manual-list")row.manual+=num(p.total);else row.receipt+=num(p.total);stats.set(p.marketId,row)}
 const rows=[...stats.values()];
 const allMarkets=d.markets.slice().sort((a,b)=>String(a.neighborhood||"ZZZ").localeCompare(String(b.neighborhood||"ZZZ"),"pt-BR")||String(a.name).localeCompare(String(b.name),"pt-BR"));
 const neighborhoods=[...new Set(allMarkets.map(m=>m.neighborhood).filter(Boolean))].sort((a,b)=>a.localeCompare(b,"pt-BR"));
 const nf=$("#marketNeighborhoodFilter"),prev=nf?.value||"";if(nf)nf.innerHTML='<option value="">Todos os bairros</option>'+neighborhoods.map(n=>`<option value="${esc(n)}">${esc(n)}</option>`).join("");if(nf&&neighborhoods.includes(prev))nf.value=prev;
 const render=()=>{const q=normalize($("#marketSearch")?.value||""),nb=$("#marketNeighborhoodFilter")?.value||"",st=$("#marketStatusFilter")?.value||"active";const filtered=allMarkets.filter(m=>{if(st!=="all"&&st==="active"&&m.active===false)return false;if(st==="inactive"&&m.active!==false)return false;if(nb&&m.neighborhood!==nb)return false;return !q||normalize(`${m.name} ${m.neighborhood||""} ${m.address||""}`).includes(q)});const byId=new Map([...stats.values()].map(x=>[x.market.id,x]));const groups=new Map();for(const m of filtered){const key=m.neighborhood||"Bairro não informado";if(!groups.has(key))groups.set(key,[]);groups.get(key).push(m)};$("#marketCards").innerHTML=[...groups.entries()].map(([bairro,ms])=>`<div class="market-neighborhood-group"><div class="market-neighborhood-title"><span>📍 ${esc(bairro)}</span><b>${ms.length}</b></div><div class="market-grid-inner">${ms.map(m=>{const x=byId.get(m.id)||{total:0,count:0,manual:0,receipt:0};return `<article class="market-card ${m.active===false?'market-inactive':''}"><div class="market-card-head"><div class="market-card-title"><h3>${esc(m.name)}</h3><span class="market-type">${m.type?esc(m.type):'Estabelecimento'}</span></div><span class="health-mini ${m.active===false?'health-pending':'health-good'}">${m.active===false?'Inativo':'Ativo'}</span></div><div class="market-address"><span aria-hidden="true">📍</span><span>${esc(m.address||"Endereço não informado")}</span></div><div class="market-card-stat"><span>Compras registradas</span><strong>${x.count?x.count:'0'}</strong><em>${x.count?money(x.total):'Sem compras'}</em></div><div class="market-card-actions"><button class="link" data-edit-market="${m.id}">Editar</button><button class="link" data-toggle-market="${m.id}">${m.active===false?'Reativar':'Desativar'}</button></div></article>`}).join('')}</div></div>`).join('')||"<div class='panel'>Nenhum estabelecimento corresponde aos filtros.</div>";$$('[data-edit-market]').forEach(b=>b.onclick=()=>editMarketModal(b.dataset.editMarket));$$('[data-toggle-market]').forEach(b=>b.onclick=()=>toggleMarket(b.dataset.toggleMarket));};
 render();
 [$("#marketSearch"),$("#marketNeighborhoodFilter"),$("#marketStatusFilter")].forEach(el=>{if(el)el.oninput=render;});
}
function editMarketModal(id){getOne("markets",id).then(m=>{if(!m)return;const body=`<div class="form-grid"><label>Nome *<input id="emName" value="${esc(m.name)}"></label><label>Tipo<select id="emType"><option>Supermercado</option><option>Mercado</option><option>Atacarejo</option><option>Hortifruti</option><option>Padaria</option><option>Outros</option></select></label><label>Bairro<input id="emNeighborhood" value="${esc(m.neighborhood||"")}"></label><label>Endereço<input id="emAddress" value="${esc(m.address||"")}"></label><label>CNPJ<input id="emCnpj" value="${esc(m.cnpj||"")}"></label><label>Cidade<input id="emCity" value="${esc(m.city||"")}"></label></div><div class="button-row" style="margin-top:13px"><button class="primary" id="saveEditMarket">Salvar</button><button class="ghost" onclick="closeModal()">Cancelar</button></div>`;openModal("Editar estabelecimento",body);$("#emType").value=m.type||"Supermercado";$("#saveEditMarket").onclick=async()=>{const name=$("#emName").value.trim();if(!name)return toast("Informe o nome.");const updated={...m,name,type:$("#emType").value,neighborhood:$("#emNeighborhood").value.trim(),address:$("#emAddress").value.trim(),cnpj:canonicalCnpj($("#emCnpj").value),city:$("#emCity").value.trim(),updatedAt:todayISO()};await put("markets",updated);await audit("Estabelecimento editado manualmente.","market",id,"update");closeModal();await renderMarkets();toast("Estabelecimento atualizado.")}})}
async function toggleMarket(id){const m=await getOne("markets",id);if(!m)return;const active=m.active===false;await put("markets",{...m,active,updatedAt:todayISO()});await audit(active?"Estabelecimento reativado manualmente.":"Estabelecimento marcado como inativo manualmente.","market",id,active?"activate":"deactivate");await renderMarkets();toast(active?"Estabelecimento reativado.":"Estabelecimento marcado como inativo.")}
async function checkMarketsOnline(){
 const panel=$("#marketUpdatePanel"),banner=$("#marketUpdateBanner"),title=$("#marketUpdateTitle"),text=$("#marketUpdateText"),results=$("#marketUpdateResults");
 if(!banner||!panel)return;
 panel.classList.remove("hidden");
 banner.dataset.state="loading";title.textContent="Conferindo online…";text.textContent="Consultando fontes públicas e comparando com sua lista. Nenhuma alteração será feita automaticamente.";results.innerHTML="";
 if(location.protocol==='file:'||location.hostname!=='localhost'){
   banner.dataset.state="warn";title.textContent="Consulta online indisponível";text.textContent="Abra o Compras da JuRe pelo servidor local (localhost) para usar a conferência online segura.";return
 }
 try{
   const d=await data();
   const r=await fetchWithRetry('/api/markets/check',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({markets:d.markets.map(m=>({id:m.id,name:m.name,type:m.type,neighborhood:m.neighborhood,address:m.address,city:m.city,state:m.state,active:m.active!==false}))})},1,60000);
   if(!r.ok)throw new Error(`HTTP ${r.status}`);
   const j=await r.json();
   renderMarketUpdateResults(j);
   banner.dataset.state=j.summary?.totalChanges?'found':'ok';
   title.textContent=j.summary?.totalChanges?`${j.summary.totalChanges} possível(is) atualização(ões) encontrada(s)`:'Nenhuma atualização relevante encontrada';
   text.textContent=`Conferência em ${new Date().toLocaleString('pt-BR')}. A lista local permaneceu intacta. Use “Incluir na lista” apenas para os estabelecimentos que você quiser adicionar.`;
   await audit(`Conferência online de estabelecimentos: ${j.summary?.totalChanges||0} possível(is) atualização(ões).`,"market-check","market-check","online-check");
 }catch(e){banner.dataset.state="warn";title.textContent="Não foi possível concluir a conferência";text.textContent=String(e.message||e);}
}
function closeMarketUpdatePanel(){
 const panel=$("#marketUpdatePanel");
 if(!panel)return;
 panel.classList.add("hidden");
 const results=$("#marketUpdateResults");if(results)results.innerHTML="";
}
async function includeOnlineMarket(x){
 const name=String(x?.name||'').trim();
 if(!name)return toast('Estabelecimento sem nome válido.');
 const d=await data();
 const nn=normalize(name), nb=normalize(x?.neighborhood||''), na=normalize(x?.address||'');
 const existing=d.markets.find(m=>normalize(m.name)===nn && (!na || normalize(m.address||'')===na) && (!nb || normalize(m.neighborhood||'')===nb));
 if(existing){toast('Esse estabelecimento já está na lista.');return}
 const now=todayISO();
 const market={id:uid('market'),name,type:x.type||'Supermercado',neighborhood:String(x.neighborhood||'').trim(),address:String(x.address||'').trim(),city:'Saquarema',state:'RJ',active:true,source:'online-audit',sourceUrl:x.sourceUrl||'',createdAt:now,updatedAt:now};
 await put('markets',market);
 await audit(`Estabelecimento incluído a partir da auditoria online: ${market.name}.`,'market',market.id,'online-include');
 await renderMarkets();
 toast(`${market.name} foi incluído na lista.`);
}
function renderMarketUpdateResults(j){
 const box=$("#marketUpdateResults");
 const groups=[['new','🆕 Novos encontrados','new'],['changed','🟡 Informações divergentes','changed'],['inactive','🔴 Possivelmente inativos','inactive'],['uncertain','⚪ Sem evidência suficiente','uncertain']];
 const html=groups.map(([key,label,cls])=>{
   const arr=j.items?.filter(x=>x.status===key)||[];if(!arr.length)return '';
   return `<div class="market-update-group ${cls}"><div class="panel-head"><h3>${label}</h3><span class="badge">${arr.length}</span></div>${arr.map((x,i)=>`<div class="market-update-row"><div class="market-update-main"><b>${esc(x.name||'Estabelecimento')}</b><div class="muted">${esc(x.neighborhood||'Bairro não informado')}${x.address?' · '+esc(x.address):''}</div><small>${esc(x.reason||'Evidência online encontrada.')}</small></div><div class="market-update-meta"><span class="confidence">${Math.round(num(x.confidence||0)*100)}%</span>${key==='new'?`<button type="button" class="link market-update-include" data-online-market='${esc(JSON.stringify(x))}'>Incluir na lista</button>`:''}</div></div>`).join('')}</div>`
 }).join('');
 box.innerHTML=html||`<div class="market-update-empty">Nenhum resultado para exibir.</div>`;
 $$('[data-online-market]').forEach(b=>b.onclick=async()=>{try{await includeOnlineMarket(JSON.parse(b.dataset.onlineMarket));b.closest('.market-update-row')?.remove();}catch(e){toast(String(e.message||e));}});
}

if($("#newMarketBtn")) $("#newMarketBtn").onclick=()=>registerMarketModal(async()=>await renderMarkets());
if($("#refreshMarketsBtn")) $("#refreshMarketsBtn").onclick=checkMarketsOnline;
if($("#closeMarketUpdateBtn")) $("#closeMarketUpdateBtn").onclick=closeMarketUpdatePanel;
...
async function resetUserData(){
  ...
  try{
    ...
    await put("meta",{id:"meta",schemaVersion:5,appVersion:APP_VERSION,resetAt:todayISO(),freshStart:true});
...
if(restoreBackupBtn && restoreBackupFile){
 ...
 try{
  ...
  if(payload.data.meta) await put("meta",{...payload.data.meta,schemaVersion:5,appVersion:APP_VERSION});
  else await put("meta",{id:"meta",schemaVersion:5,appVersion:APP_VERSION,restoredAt:todayISO()});
...
$("#saveImportBtn").onclick=async()=>{
 ...
 const items=[];edited.items.forEach(it=>{const match=findExistingProduct(d.products,it);const product=match||{id:uid("prod"),barcode:it.barcode||"",name:cleanProductName(it.name),brand:it.brand||"",category:it.category||"Outros",pack:it.pack||guessPack(it.name),unit:it.unit||"un",health:"Não classificado",active:true,createdAt:todayISO(),updatedAt:todayISO()};items.push({id:uid("item"),purchaseId:p.id,productId:product.id,barcode:it.barcode||"",descriptionRaw:it.name,quantity:num(it.quantity),unit:it.unit||product.unit,pack:it.pack||product.pack,unitPrice:num(it.unitPrice),lineTotal:num(it.total),discount:num(it.discount),totalAfterDiscount:round2(num(it.total)-num(it.discount)),confidence:clamp(num(it.confidence)||.7),needsReview:!!it.needsReview,sectorSnapshot:product.sector||product.category||"Outros",healthSnapshot:product.health||"Não classificado",fieldEvidence:edited.audit?.evidence?.items?.[it.lineId]||it.fieldEvidence||null,purchaseDate:date,createdAt:todayISO(),updatedAt:todayISO()});if(!match)d.products.push(product)});
