const CACHE="compras-jure-v2.6.5-shell";
const SHELL=["./","./index.html","./styles.css","./app.js","./manifest.json","./modules/receipt-engine.js","./modules/receipt-auditor.js","./updates/manifest.json","./test-fixtures/comprovante-alvorada-2026-09-10.jpg"];
