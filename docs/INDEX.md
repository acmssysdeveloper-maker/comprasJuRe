# Documentação — Compras da JuRe 2.8.6
...
- `docs/RELEASE_AUDIT_2.8.6.md` — auditoria da release vigente
- `docs/TEST_RUN_2.8.6.txt` — registro da validação da release vigente

## Documentação histórica

Arquivos com versões 2.6.x e 2.7.x registram auditorias, testes e decisões de releases anteriores. Eles **não representam o contrato vigente** da 2.8.6 e são mantidos para rastreabilidade.

## Regra de versionamento

- `APP_VERSION = 2.8.6`: versão funcional do aplicativo.
