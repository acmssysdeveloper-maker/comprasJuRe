# Auditoria online de estabelecimentos — v2.8.13

## Objetivo

A versão 2.8.13 introduz uma conferência online sob comando explícito do usuário. A função não é um sincronizador automático: ela consulta fontes públicas, cruza evidências e apresenta possíveis atualizações sem alterar a lista local.
